        ...
        return (
            <main>
                ...
                <section className="u-pad-top-50 u-pad-top-120@lrg">
                    ...
                    <Wrapper fullWidth>
                        <Tile
                            className="u-bg-eta [ u-pad-top-30 u-pad-top-60@lrg ] [ u-pad-btm-20 u-pad-btm-80@lrg ]"
                            number="01."
                        ...
                        />
                        <Tile
                            className="u-bg-gamma [ u-pad-top-30 u-pad-top-60@lrg ] [ u-pad-btm-20 u-pad-btm-80@lrg ]"
                            number="02."
                        ...
                        />
                        <Tile
                            className="u-bg-theta [ u-pad-top-30 u-pad-top-60@lrg ] [ u-pad-btm-20 u-pad-btm-80@lrg ]"
                            number="03."
